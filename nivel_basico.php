...
<html lang="es">
  ...
  <body>
    ...
    <img src="imagenes/nivel_basico.jpg" alt="Nivel basico" class="hero-image"/>
    ...
    <!-- Sección de Video Nivel Básico -->
    <div class="row">
      <?php
        include('conexion.php');

        // Consulta SQL para obtener los videos de nivel básico
        $sql = "SELECT * FROM clases_online WHERE nivel_video = 'basico'";
        ...
        if ($result === false) {
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    echo '<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#videoModal" onclick="cargarVideo(\'' . $videoUrl . '\')">Ver Video</button>';
                    echo '</div>';
                    echo '</div>';
                    echo '</div>';
                }
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="videoModalLabel">Nivel Básico</h5>
