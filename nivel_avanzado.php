...
<html lang="es">
  ...
  <body>
    ...
    <img src="imagenes/nivel_avanzado.jpg" alt="Nivel avanzado" class="hero-image"/>

    <!-- Texto Descriptivo -->
    <div class="container my-4">
      <p>En nuestra plataforma, te ofrecemos una serie de videos diseñados especialmente para quienes están comenzando su práctica de yoga. 
         Ya sea que nunca hayas hecho yoga antes o desees profundizar en los fundamentos, estos videos te guiarán paso a paso para que puedas
         disfrutar de los beneficios del yoga en tu propio ritmo.</p><br>
    </div>

    <div class="container my-4">
      <p>Con el apoyo de nuestros instructores experimentados, aprenderás a través de movimientos suaves y respiraciones conscientes,
         creando un espacio de calma y equilibrio en tu vida. Tómate un momento para ti, desconecta del estrés diario y comienza tu 
         viaje hacia una mejor salud física y mental.</p>
    </div>

    <!-- Sección de Video Nivel Avanzado -->
    <div class="row">
      <?php
        include('conexion.php');

        // Consulta SQL para obtener los videos de nivel avanzado
        $sql = "SELECT * FROM clases_online WHERE nivel_video = 'avanzado'";
        ...
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                ...
                echo '<p class="card-text">' . $row['descripcion_video'] . '</p>';
                echo '<button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#videoModal" onclick="cargarVideo(\'videos/' . $row['video'] . '\')">Ver Video</button>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
            }
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="videoModalLabel">Nivel Avanzado</h5>
    ...
    <script>
      ...
      function cargarVideo(url) {
        ...
        // Limpiar el contenido anterior y agregar el nuevo video
        modalBody.innerHTML = ''; 
